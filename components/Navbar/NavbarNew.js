  ...
  function onhamburgerHandler(){
    ...
    return (
      <Fragment>
        <section id="hero">
          {/* Hero Container */}
          <div className={`container max-w-6xl mx-auto px-6 md:py-12 pt-12 pb-3 ${showHamburger ? 'mb-96' : ''}`}>
            {/* Nav/Logo Container*/}
            <nav className="flex items-center justify-between font-bold text-white">
              <div>
                <p className="md:text-4xl text-3xl capitalize underline font-sans tracking-wider hover:scale-110 hover:translate-y-4">Meetly</p>
              </div>
            ...
            >
              ...
              <Link href="/#about" class="hover:text-pink-500">
                About
              </Link>
